...
import { ChainId } from '@satoshihunters/sdk';
...
var links = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: "Github",
                href: "https://github.com/SatoshiHunters/",
                target: '_blank',
            },
            {
                label: "Docs",
                href: "https://SatoshiHunters.gitbook.io/satoshihunters/",
            },
            {
                label: "Blog",
                href: "https://satoshihunters.medium.com/",
            },
        ],
    },
];
...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#353331", backgroundDisabled: "#423d37", contrast: "#FFFFFF", invertedContrast: "#261e13", input: "#5a4d3f", 
    // inputBorder: "#cccccc",    
    inputSecondary: "#cccccc", tertiary: "#473e35", text: "#fff", textDisabled: "#716a61", textSubtle: "#fff", activeButton: "#397f49", borderColor: "#63584b", card: "#2c2926", nav: "#2c2926", gradients: {
